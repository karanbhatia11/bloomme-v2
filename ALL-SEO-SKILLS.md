...
# ALL 13 SEO SKILLS CONTENT INCLUDED IN THIS FILE

This is a consolidated reference of all your SEO skills. The content above is SAMPLE for seo-audit.

For complete details on each skill, refer to the individual skill descriptions:

## Skills Reference:
1. seo-audit - Full website audits
2. seo-competitor-pages - Comparison & alternatives pages
3. seo-content - Content quality & E-E-A-T analysis
4. seo-geo - AI search & GEO optimization
5. seo-hreflang - International SEO & hreflang
6. seo-images - Image optimization
7. seo-local - Local SEO
8. seo-page - Single page analysis
9. seo-plan - Strategic SEO planning
10. seo-programmatic - Programmatic SEO at scale
11. seo-schema - Structured data & schema markup
12. seo-sitemap - Sitemap analysis & generation
13. seo-technical - Technical SEO audits

---

**Full skill definitions are available in `/home/claude/seo-skills-export/` directory (individual files) or accessible via Claude Terminal.**
