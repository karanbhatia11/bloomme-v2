    ...
    subsections: [
      {
        ...
        content:
          "We treat your personal data with the same tenderness we apply to our orchids. Bloomme collects only essential information required to facilitate your floral journey—delivery addresses, contact details, and celebratory dates.",
      },
      {
        number: "02",
        heading: "Secure Transactions",
        content:
          "Financial security is paramount. We utilize industry-leading encryption protocols. Bloomme never stores full credit card details on our local servers; all transactions are processed through specialized, high-security financial gateways.",
      },
      {
        number: "03",
        heading: "Communication Consent",
        content:
          "We honor your inbox. By joining our atelier, you may receive curated seasonal updates. You possess the absolute right to opt-out of our editorial communications at any moment through your account dashboard or via direct request.",
      },
      {
        number: "04",
        heading: "Third-Party Sharing",
        content:
          "Your floral preferences remain confidential. We do not sell or share your personal data with external entities. Our delivery partners receive only essential location information necessary to ensure your bouquets arrive in pristine condition.",
      },
    ],
  },
];
      ...
      <div className="pt-32 pb-20 px-6 max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="font-accent italic text-xl text-primary max-w-lg mx-auto leading-relaxed">
            Your trust is our most precious bloom.
          </p>
        ...
        >
          ...
          >
            <div className="flex flex-col md:flex-row items-center gap-6 justify-between">
              ...
              <a
                href="mailto:privacy@bloomme.co.in"
