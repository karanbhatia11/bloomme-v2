        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <p className="text-on-surface-variant text-lg md:text-xl max-w-xl leading-relaxed mb-8">
              At Bloomme, we believe flowers are a silent language of the soul.
              We curate botanical experiences that bridge tradition and modern
              elegance.
            </p>
          ...
          >
            <div className="rounded-2xl overflow-hidden aspect-[4/5] shadow-2xl hover:shadow-xl transition-all duration-500">
              <img
                ...
                alt="High-end floral arrangement with soft pink peonies"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuBbPchiGMM45_qQyJbBdhsOj02PEo8KNhZYKiZ5hAF2RrH74Wb3gjoiWpWAmLnfVqNmW5yVBgwRsXU9ZT0EUpFfuA8lF94DPUp8-5FdLAWbvClwE9b5OH2yb8bbF0QBjagIO7vF1iqHA6SrTfNzoFnMZ5vOM9qpRMRTtNPouJ4wS9uM_skkUWjXxvEK7kTx0rUIYv3F-sGl-LUqkegZNy6XQXZLRaiU52btZDSNX0sW_VZQQyqN5jyRVE-cInNKxufmHldvLd-mz-kL"
              />
            </div>
            <div className="absolute -bottom-10 -left-10 w-48 h-48 rounded-xl overflow-hidden shadow-xl hidden md:block">
              <img
                className="w-full h-full object-cover"
                alt="Macro shot of vibrant flower petals with morning dew"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuAmuJSsl2nCgozTNhhHsVC5LzpWPUKYE6-N8YueZ6UqZ4o1Tp5aJ_RIrWiFAenOfHSnClcmWl2ng4f8JWBXNdIvSMkEIeERC2wMk0mbCsXR-7CxUQ_6ftXYsIhTe_qMNwmtehPtuyP_447nqz6NgPNf4WWKqXRqOUBegDm7YadNHGRvmj8YQ48xX6J9KjJavx1GnVHA325IXb3umto_of8MIvML_-S9Zc9Ce-p3mG5mpmB2OTykw9flXflvf3vgylPysvZh4TAuDC-M"
              />
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="bg-surface-container p-12 rounded-[2rem] relative overflow-hidden">
                ...
                <div className="space-y-6 text-on-surface-variant leading-relaxed">
                  <p>
                    It began in a small backyard in the outskirts, with nothing
                    but a handful of heirloom seeds and a vision to bring
                  ...
                  <p>
                    ...
                    our heart remains in that garden. We hand-pick every stem,
                    ensuring that the devotion we put into our craft is felt in
                    every delivery.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <p className="text-2xl font-light text-on-background leading-relaxed">
                To nurture the bond between nature and human emotion through
                conscious, artistic floristry.
              </p>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="aspect-square bg-primary-container rounded-xl flex items-center justify-center p-8 text-center text-on-primary-container hover:shadow-lg transition-shadow">
                  <div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="font-accent italic text-xl text-on-surface-variant">
              The pillars that define the Bloomme experience.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            >
              <div>
                ...
                <p className="text-on-surface-variant group-hover:text-on-primary-container/80 transition-colors">
                  Every bloom is sourced from organic growers, ensuring that
                  what enters your home is as clean as nature intended. No
                  harsh chemicals, just pure botanical life.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-on-surface-variant">
                Honoring ceremonial practices with specialized arrangements for
                sacred rituals.
              </p>
            </motion.div>
            ...
            >
              <div className="flex-1 z-10">
                ...
                <p className="text-surface-variant/80 text-lg leading-relaxed">
                  We support local artisanal growers and donate 5% of all
                  proceeds to urban greening projects. We are part of the earth
                  we inhabit.
                </p>
              </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-on-primary-container/80 text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Join our circle of flower enthusiasts and receive weekly botanical
              inspiration and exclusive seasonal drops.
            </p>
